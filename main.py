...
parse.add_argument('-traffic', type=str, default='chengdu')

parse.add_argument('-close_size', type=int, default=5)
parse.add_argument('-period_size', type=int, default=3)
parse.add_argument('-trend_size', type=int, default=1)
...
parse.set_defaults(fusion=True)
...
def main():
    ...
    file_name = 'File_{:}_GCN_{:}_Layer_{:}_Fusion_{:}_LR_{:.5f}_Depth_{:}_Flow_{:}' \
                '_Loss_{:}_Gate_{:}_Alpha_{:}_Beta_{:}_c_{:}_p_{:}_t_{:}_Exp_{:}'.format(args.traffic,
                                                                                         args.gcn_type, args.gcn_layer,
                                                                                         args.fusion,
                                                                                         args.lr,
                                                                                         args.depth, args.ff,
                                                                                         args.loss, args.gate_type,
    ...
    for i in range(1):
        ...
        for epoch in range(args.epoch_size):
            ...
            print('Round, {:}, Epoch, {:}, File, {:}, Pickup RMSE, {:.4f}, MAE, {:}, MAPE, {:.5f}, '
    ...
    print(
        ...
        'C: {:}, P: {:}, T: {:}, Flow: {:}, Fusion: {:}, '
        'Pickup RMSE: {:.4f}, MAE: {:.3f}, MAPE: {:.5f}, '
        'Dropoff RMSE: {:.4f}, MAE: {:.3f}, MAPE: {:.5f}, RMSE: {:.4f}, '
